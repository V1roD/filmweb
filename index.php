            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    <div class="filter-control">
                        <ul>
                            <li class="active">Phim Chiếu Rạp</li>
                        </ul>
                    </div>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <div class="filter-control">
                        <ul>
                            <li class="active">Xem Miễn Phí</li>
                        </ul>
                    </div>
                    <div class="product-slider owl-carousel">
                    <?php 
                        ...
                        while($tmp = $result->fetch_assoc()) {
                            echo "<form action=\"detail1.php\" method=\"GET\">";
                            $url = "images/" . $tmp['Poster'];
                            ...
                            echo "<input name=\"id\" type=\"hidden\" value=\"{$tmp['id']}\">";
                            echo "<button type=\"submit\" class=\"btnChiTiet\">Xem Phim</button>";
                            // echo "<button class=\"btnMuaVe\">Mua vé</button>";
                            echo "</div>";
                            echo "</ul>";
                            echo "</form>";
